...
var BottomNavItem = function (_a) {
    ...
    return dropdown ? (React__default['default'].createElement(StyledBottomNavItem, __assign({ type: "button" }, props), bottomNavItemContent)) : (React__default['default'].createElement(StyledBottomNavItem, __assign({ as: reactRouterDom.Link, to: href }, props), bottomNavItemContent));
};
...
var BottomNav = function (_a) {
    ...
    return (React__default['default'].createElement(StyledBottomNavItem$1, __assign({ justifyContent: "space-around" }, props), items.map(function (_a) {
        ...
        if (dropdown) {
            ...
            return (showOnMobile && (React__default['default'].createElement(BottomNavItem, { href: href, isActive: href === activeItem, label: label, iconName: icon, showItemsOnMobile: showItemsOnMobile })));
        }
    })));
};
